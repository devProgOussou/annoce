            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <jet-nav-link :href="route('user.display')" :active="$page.currentRouteName == 'user.display'">
                            Administration
                        </jet-nav-link>
                        <jet-nav-link :href="route('advertisements.index')" :active="$page.currentRouteName == 'advertisements.index'">
                            annonces
                        </jet-nav-link>
                        <jet-nav-link :href="route('advertisements.create')" :active="$page.currentRouteName == 'advertisements.create'">
                            poster annonce
                        </jet-nav-link>
                    </div>
                </div>
